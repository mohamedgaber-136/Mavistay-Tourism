'use client'
import BitrixForm from "@/components/elements/BitrixForm"
...
const {i18n} = useTranslation()
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={2} breadcrumbTitle=" تواصل معنا">
                <div>
                                ...
                                <div className="row g-4 align-items-center">
                                    <div className="col-lg-6">
                                        <div className="contact-left-items ">
                                            <div className={`contact-info-area-2 ${i18n.dir() =='rtl'&&'reverseDir'}`}>
                                                <div className="contact-info-items mb-4">
                                                    ...
                                                    <div className="content" dir="ltr">
                                                        <p className="text-end">Call Us 7/24</p>
                                                        <h3>
                                                            <Link href="/tel:+90 554 017 22 22">  +90 554 017 22 22</Link>
                                                        </h3>
                                                    </div>
                                                </div>
                                                <div className="contact-info-items mb-4">
...
">                           İnfo@mavistay.com 
                                                ...
                                                <div className="row g-4">
                                                    ...
                                                    <div className="col-lg-7 wow fadeInUp" data-wow-delay=".9s">
                                                        <button type="submit" className="theme-btn">
                                                            ارسال  <i className="fa-solid fa-arrow-left-long" />
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
                    ...
                    {/*<< Map Section Start >>*/}
                    <div className="map-section " style={{height:'250px'}}>
                        <div className="map-items">
                            <div className="googpemap">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3007.6398162441956!2d28.955913300000002!3d41.0768652!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab7d23ac88fa1%3A0x4e0eb2200b8d3549!2sB%20Royal%20Group%20Tourism%20Ltd.%20Company!5e0!3m2!1sar!2seg!4v1720435744934!5m2!1sar!2seg" width={"600"} height={"450"} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
